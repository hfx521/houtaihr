    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          ...
          <a target="_blank" href="https://github.com/hfx521/houtaihr">
    ...
    <el-dialog width="500px" title="修改密码" @close="btnCancel" :visible.sync="showDialog">
      ...
      <el-form ref="passForm" label-width="120px" :model="passForm" :rules="rules">
        ...
        <el-form-item>
         ...
         <el-button @click="btnCancel" size="mini" type="primary">取消</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
...
// 如果你想引入 element-ui 库的 Footer 组件，应该直接从 element-ui 中引入：
...
export default {
  ...
  computed: {
    //引入头像 和用户名称
    ...mapGetters([// 辅助函数 自动引入getters中的属性
      'sidebar',
      'avatar',
      'name'
    ])
